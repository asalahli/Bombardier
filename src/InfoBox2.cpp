...
InfoBox2::InfoBox2(Screen& screen)
    : GameObject(screen)
{
    ...
    help1.setFont(*font);
    help1.setString("You're dead");
    help1.setCharacterSize(64);
    help1.setColor(sf::Color::Red);
    help1.setPosition(140, 165);
    help1.setStyle(sf::Text::Bold);

    help2.setFont(*font);
    help2.setString("Click to restart");
    help2.setCharacterSize(48);
    help2.setColor(sf::Color::White);
    help2.setPosition(120, 350);
...
void InfoBox2::update(float dt) {
    GameObject::update(dt);
}

void InfoBox2::draw(sf::RenderTarget& target, sf::RenderStates states) const {
    target.draw(bg);
...
void InfoBox2::setBoxCoords(sf::FloatRect box) {
